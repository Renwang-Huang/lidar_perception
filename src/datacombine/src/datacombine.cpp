...
DataCombineNode::DataCombineNode() : Node("data_combine_node")
{
  // 加载外参配置并预计算矩阵
...
void DataCombineNode::loadAndPrecomputeParams()
{
...
void DataCombineNode::cloud1Callback(const livox_ros_driver2::msg::CustomMsg::ConstSharedPtr msg)
{
...
void DataCombineNode::cloud2Callback(const livox_ros_driver2::msg::CustomMsg::ConstSharedPtr msg)
{
...
void DataCombineNode::syncCallback(const livox_ros_driver2::msg::CustomMsg::ConstSharedPtr& cloud1_msg,
...
void DataCombineNode::imuCallback(const sensor_msgs::msg::Imu::ConstSharedPtr msg)
{
...
Eigen::Matrix4f DataCombineNode::createTransformMatrix(float roll, float pitch, float yaw,
